...
/**
 * Maps {@link Result} to {@link Person} .
 */
@Reusable
public final class PersonResultEntityMapper implements EntityMapper<Result, Person> {
    ...
    @Override
    public Person map(Result entity) throws MappingError {
