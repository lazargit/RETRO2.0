 ...
 */
public final class USECASE_InitTables implements UseCaseFlowable<ParamsBasic,String> {
    ...
    @Inject
    USECASE_InitTables(RemoteRepository repository, CacheRepository cache, LocalRepository localRepository, DataConfig dataConfig) {
...
//        }
    ...
    public static final class Params implements ParamsBasic {
        ...
        public static Params with(String language) {
            return new Params(language);
        }
